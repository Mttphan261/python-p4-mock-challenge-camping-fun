...
Revision ID: 4efbf373ddfe
Revises: 6bbc545b0d61
Create Date: 2023-06-21 09:29:51.519782
...
def upgrade():
    ...
    with op.batch_alter_table('signups', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key(batch_op.f('fk_signups_activities_id_activities'), 'activities', ['activities_id'], ['id'])
...
def downgrade():
    ...
    with op.batch_alter_table('signups', schema=None) as batch_op:
        ...
        batch_op.drop_constraint(batch_op.f('fk_signups_activities_id_activities'), type_='foreignkey')
